...
class MyFashionMnist(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self) -> tfds.core.DatasetInfo:
      return tfds.core.DatasetInfo(
          builder=self,
          description=("The Fashion MNIST database of cloths."),
  ...
  def _generate_examples(self, num_examples, data_path, label_path):
    ...
    """
    images = _extract_fmnist_images(data_path, num_examples)
    labels = _extract_fmnist_labels(label_path, num_examples)
...
def _extract_fmnist_images(image_filepath, num_images):
...
def _extract_fmnist_labels(labels_filepath, num_labels):
